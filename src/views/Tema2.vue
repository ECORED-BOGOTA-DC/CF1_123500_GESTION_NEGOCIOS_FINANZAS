...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.cs
        ...
        .row.justify-content-center
          .row
            .col-lg-2(data-aos="fade-left") 
              img.mt-3(src='@/assets/curso/images/tema2/ico_1.svg')
            .col-lg-4
              h4.mt-3 Método
              p.mb-0 El método es el procedimiento general. 
          .row
            .col-lg-2(data-aos="fade-left") 
              img.mt-4(src='@/assets/curso/images/tema2/ico_2.svg')
            .col-lg-4
              h4.mt-3 Técnica
              p.mb-0 La técnica se refiere a las maneras de abordar distintas actividades de forma estandarizada.
          .row
            .col-lg-2(data-aos="fade-left") 
              img.mt-5(src='@/assets/curso/images/tema2/ico_3.svg')
            .col-lg-4
              h4.mt-5 Instrumentos 
              p.mb-3 Los instrumentos son los mecanismos para recoger la información de forma direccionada y organizada.       
            .col-lg-4(data-aos="fade-left") 
              img(src='@/assets/curso/images/tema2/ico_4.svg')
    ...
    .titulo-sexto.color-acento-contenido.mb-3(data-aos="zoom-in-right")
      h5 Figura 6
      span Tipos de triangulación

    .row.align-items-center.justify-content-center.mb-3
      .col-lg-10(data-aos="fade-left") 
          img.mt-3(src='@/assets/curso/images/tema2/fig_1.svg')
    Separador 
  ...
  .container.bg-white.px-md-5.px-3.py-2.container-top.fondo-4.mb-0.mg-top-1
  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.mb-5 
    ...
    .row.align-items-center.align-items-center.my-5
      .col-lg-12
        TabsA.color-acento-contenido(data-aos="fade")
          ...
          .tarjeta.back-tab.px-5.py-4(titulo="Entrevistas")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
          ...
          .tarjeta.back-tab.px-5.py-4(titulo="Recopilación/Revisión/Análisis documental")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
                ...
                p.mb-0 Cruzar la información encontrada a través de la lectura y compararla en aspectos o hallazgos previamente realizados, lo que aportará al desarrollo de una síntesis sobre la realidad estudiada.
                p.mb-3 El tipo de información base para realizar el análisis documental son escritos, documentos numéricos y documentos cartográficos.
     
          .tarjeta.back-tab.px-5.py-4(titulo="Focus group")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
                p.mb-3 Es una herramienta o instrumento cualitativo de recolección de datos. Consiste en realizar una entrevista en grupo, con el objetivo de recoger información sobre un número específico de preguntas. Es muy útil para recoger información de manera inmediata y espontánea, bajo la instrucción de un moderador, el cual socializa la herramienta y presenta el objetivo de su aplicación.


          .tarjeta.back-tab.px-5.py-4(titulo="Autorreportaje")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
                p.mb-3 Es una técnica donde el mismo informante reportará su situación o experiencia solicitada por el investigador. Para desarrollar el autorreportaje, es necesario elaborar un guion con preguntas puntuales y fundamentales relacionadas con el suceso o vivencia.
             
            
          .tarjeta.back-tab.px-5.py-4(titulo="Categorización. Triangulación y Teoría fundamentada")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
          ...
          .tarjeta.back-tab.px-5.py-4(titulo="Triangulación")
            .row.px-2.py-2.justify-content-center.align-items-star
              .col-lg-12
    ...
    .row.align-items-center.justify-content-center.mb-3
      .col-lg-7(data-aos="fade-right") 
         ul.lista-ul--color.mt-3
          li.mb-4
            i.fa-folder
            | Si el grupo tiene poder, es legítimo y además influye en el logro de objetivos. Su función en la organización es crucial y determinante
          li.mb-4
            i.fa-folder
            | Se deben considerar grupos de interés aquellos que aparecen de manera latente, aunque su relevancia sea escasa, con el fin de promover la participación como parte de la motivación grupal e individual de sus participantes.
          li.mb-4
            i.fa-folder
    ...
    .row.align-items-center.justify-content-center.mb-5
      .col-lg-10
        .titulo-sexto.color-acento-contenido.mb-3(data-aos="zoom-in-right")
          h5 Figura 9
          span Aspectos que definen los grupos de interés
        img.mt-3(src='@/assets/curso/images/tema2/fig_4.svg')
